...
import redis.clients.jedis.commands.XCommands;
import redis.clients.jedis.commands.XBinaryCommands;
...
public class JedisX implements XCommands, XBinaryCommands,
    AutoCloseable {
